...
const initialCourses = [
    ...
    { id: 3, name: "Web Design Fundamentals", description: "Master the principles of web design", students: 45 },
]
                    ...
                    <Card key={course.id} className="flex flex-col">
                        ...
                        <CardContent className="flex-grow flex flex-col justify-between">
                            <div>
                                ...
                                <p className="mb-4 text-sm font-medium">{course.students} students enrolled</p>
                            </div>
