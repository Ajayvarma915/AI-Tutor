...
const coursesData = {
    1: { id: 1, name: "Introduction to React", description: "Learn the basics of React", students: 50, topics: [] },
    2: { id: 2, name: "Advanced JavaScript", description: "Deep dive into JavaScript concepts", students: 30, topics: [] },
    3: { id: 3, name: "Web Design Fundamentals", description: "Master the principles of web design", students: 45, topics: [] },
}
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Card className="w-full">
                <CardHeader>
                    <CardTitle className="text-2xl sm:text-3xl text-center sm:text-left">{course.name}</CardTitle>
                </CardHeader>
